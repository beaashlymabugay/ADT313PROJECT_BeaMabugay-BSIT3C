...
const Form = () => {
  ...
  const validateForm = () => {
    const errorMessages = [];
    if (!formData.title) errorMessages.push("The title is a must to be provided");
    if (!formData.overview) errorMessages.push("An overview is a must to be provided");
    if (!formData.releaseDate) errorMessages.push("Release date is a must to be provided");
    if (!formData.popularity) errorMessages.push("Popularity is a must to be provided");
    if (!formData.voteAverage) errorMessages.push("Vote average is a must to be provided");
    if (!selectedMovie) errorMessages.push("Selecting a movie from the search results is a must to be provided");
